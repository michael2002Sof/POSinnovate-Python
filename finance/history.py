...
class FinanceHistory:
    ...
    def __init__(self):
        # No guarda transacciones, siempre consulta el origen (igual que antes)
        pass
...
-----------------------------""")
    ...
    # -------------------------------------------------------------
    def history_by_date(self, date_str):
        transactions = get_all_transactions()
...
-----------------------------""")
    ...
    # -------------------------------------------------------------
    def history_by_range(self, start_date, end_date):
        transactions = get_all_transactions()
